      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-2">
          <div className="flex flex-wrap items-center gap-1.5 min-w-0">
            ...
            <span className="inline-flex items-center rounded-md border border-stone-200/90 bg-stone-100 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider text-stone-500">
              {t("home.demoPreview")}
            </span>
          </div>
          <span className={`inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-[10px] font-bold shrink-0 ${urgencyStyle}`}>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 pb-14 pt-12 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:pb-24 lg:pt-20">
          ...
          <div>
            ...
            <div className="animate-fade-up-delay-3 mt-8 flex flex-wrap items-center gap-3">
              <Link
                href="/requests/new"
                className="button button-primary group px-6 py-3 text-base shadow-glow-sm hover:shadow-glow"
                id="hero-primary-cta"
              >
                <Droplets className="h-5 w-5 text-white/90 transition-transform duration-200 group-hover:scale-110" aria-hidden />
                <span>{t("home.requestBlood")}</span>
                <ArrowRight className="h-4 w-4 transition-transform duration-200 group-hover:translate-x-1" aria-hidden />
              </Link>
              <Link
                href="/donor"
                className="button button-secondary px-5 py-3 text-base"
                id="hero-donor-cta"
              >
              ...
              <a
                href="#how-it-works"
                className="inline-flex items-center gap-1 px-3 py-2 text-sm font-bold text-stone-500 transition hover:text-brand-600"
